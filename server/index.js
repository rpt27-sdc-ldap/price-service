...
const whiteList = ['http://54.183.2.218','http://54.153.95.228','http://34.221.235.141','http://34.219.131.242','http://13.57.14.144','http://76.94.227.26','http://18.188.135.5','http://18.188.223.199'];
const corsOpts = {
  origin: (origin, cb) {
